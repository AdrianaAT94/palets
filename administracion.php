...
<head lang="es">
    ...
    <body class="body admin">
        <?php
            if ($deviceType == 'tablet' ) { ?>
                <div class="cabecera admin"><?php include('php/cabecera.php')?></div>
                <div class="zona_admin"><?php include('php/cuerpo_movil.php')?></div>
                <div class="footer admin"><?php include('php/footer.php')?></div>
        ...
        if(!isset($_SESSION['administrador'])) { 
            if (isset($_REQUEST['enviar'])) {
                    ...
                    $password = mysqli_real_escape_string($con, $password);
                        ...
                        **le ha enviado*/
                        $result = mysqli_query($con, "SELECT * FROM administrador WHERE login = '$login'");
