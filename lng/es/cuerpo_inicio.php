        ...
        <div class="cuerpo">
            ...
            <div class="seccion seccion2" id="seccion2">
                ...
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">PRODUCTOS</span></h1>
                    </div>
                    <div class="productos">                        
                    <?php 
                        ...
                        if ($j == 1){ ?>                         
                            <div class="des_producto activo" id="des_producto1">
                                ...
                                <div class="texto_producto">
                                    <h3><?php echo $row3['nombre_es']; ?></h3>
                                    <h5>PRECIO: <?php echo $row3['precio']; ?> €</h5>
                                    <p><?php echo $row3['descripcion_es']; ?></p>
                                </div>
                                <div class="clear"></div>
                            </div>                           
                        <?php } 
            ...
            data-3000="background-position: 50% -10%;" >
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">CALIDAD</span></h1>
                    </div>
            ...
            <div class="seccion seccion4" id="seccion4">
                ...
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">NOTICIAS</span></h1>
                    </div>
                    <?php
                    $f = 1;
                    ...
                    while($row6 = mysqli_fetch_assoc($rs_noticias2)){  ?>                                                          
                        <div class="noticia_index" id="noticia<?php echo $h; ?>">
                            <div class="contenido_noticia_index">
                                ...
                                <div class="titulo_contenido_noticia_index">
                                    <h3><?php echo $row6['nombre_es']; ?></h3>
                                </div>
                                <div class="texto_noticia_index">
                                    <p><?php echo substr($row6['texto_es'], 0, 150); ?></p>
                                </div>
                                <div class="clear"></div>
                            </div>                                  
                        </div>    
            ...
            <div class="seccion seccion5" id="seccion5">
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">LOCALIZACIÓN Y CONTACTO</span></h1>
                    </div>
                        ...
                        <div class="col3">
                            ...
                            <div class="iconos_sociales">
                                <div class="icono_social face">
                                    ...
                                    <div class="text_cont">
                                        <h3>
                                             <a href="#" target="_blank">Nuestro facebook</a>
                                        </h3>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <div class="icono_social twitter">
                                    ...
                                    <div class="text_cont">
                                        <h3>
                                             <a href="#" target="_blank">Nuestro twitter</a>
                                        </h3>
                                    </div>
                                    <div class="clear"></div>
                                </div>
