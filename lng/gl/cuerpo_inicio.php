        ...
        <div class="cuerpo">
            <div class="seccion seccion1" id ="seccion1">
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">EMPRESA</span></h1>
                    </div>
            ...
            <div class="seccion seccion2" id="seccion2">
                ...
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">PRODUTOS</span></h1>
                    </div>
                    <div class="productos">                        
                    <?php 
                        ...
                        if ($j == 1){ ?>                         
                            <div class="des_producto activo" id="des_producto1">
                                ...
                                <div class="texto_producto">
                                    <h3><?php echo $row3['nombre_gl']; ?></h3>
                                    <h5>PREZO: <?php echo $row3['precio']; ?> €</h5>
                                    <p><?php echo $row3['descripcion_gl']; ?></p>
                                </div>
                                <div class="clear"></div>
                            </div>                           
                        <?php } 
            ...
            data-3000="background-position: 50% -10%;" >
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">CALIDADE</span></h1>
                    </div>
            ...
            <div class="seccion seccion7" id="seccion7">
                ...
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">OFERTAS</span></h1>
                    </div>
            ...
            <div class="seccion seccion4" id="seccion4">
                ...
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">NOVAS</span></h1>
                    </div>
                    <?php
                    $f = 1;
                    ...
                    while($row6 = mysqli_fetch_assoc($rs_noticias2)){  ?>                                                          
                        <div class="noticia_index" id="noticia<?php echo $h; ?>">
                            <div class="contenido_noticia_index">
                                ...
                                <div class="titulo_contenido_noticia_index">
                                    <h3><?php echo $row6['nombre_gl']; ?></h3>
                                </div>
                                <div class="texto_noticia_index">
                                    <p><?php echo substr($row6['texto_gl'], 0, 150); ?></p>
                                </div>
                                <div class="clear"></div>
                            </div>                                  
                        </div>    
            ...
            <div class="seccion seccion5" id="seccion5">
                <div class="contenido_variable">
                    <div class="titulo_seccion der">
                        <h1><span class="grande">LOCALIZACIÓN E CONTACTO</span></h1>
                    </div>
                    <div class="seccion_contacto">
                        <div class="formulario_contacto">
                            <form method="post" action="" name="formulario" class="formulario_contacto" enctype="multipart/form-data">
                                <input type="text" class="col2" name="nombre" placeholder="Nombre" required />
                                <input type="text" class="col2" name="apellido" placeholder="Apellido" required />
                                <input type="text" class="col2" name="mail" placeholder="E-mail" required />
                                <input type="text" class="col2" name="asunto" placeholder="Asunto" required />
                                <input type="file" class="col2 archivo" name="archivo" />
                                <textarea type="text" class="col1" name="mensaje" placeholder="Mensaje" required ></textarea>
                                <input type="submit" class="boton_enviar" name="enviar" value="enviar" />
                            </form>
                            <?php
                            ...
                            echo "
                            <h2>O seu formulario enviado con éxito </h2>
                            <form>
                                <p>Moitas Grazas </p>
                        ...
                        <div class="col3">
                            ...
                            <div class="iconos_sociales">
                                <div class="icono_social face">
                                    ...
                                    <div class="text_cont">
                                        <h3>
                                             <a href="#" target="_blank">O noso facebook</a>
                                        </h3>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <div class="icono_social twitter">
                                    ...
                                    <div class="text_cont">
                                        <h3>
                                             <a href="#" target="_blank">O noso twitter</a>
                                        </h3>
                                    </div>
                                    <div class="clear"></div>
                                </div>
